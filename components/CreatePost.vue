<template>
  <div class="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-3xl p-6 mb-8 hover:border-neutral-700 transition-all duration-300 shadow-xl group">
    ...
    <div class="space-y-4">
      ...
      <div class="relative">
        <textarea
          ...
          rows="4"
          maxlength="2000"
          class="w-full px-5 py-3 bg-neutral-800/50 border border-neutral-700 rounded-xl text-white placeholder-neutral-500 focus:border-neutral-400 focus:outline-none resize-none transition-all duration-300"
        ></textarea>
      ...
      <div class="flex items-center gap-4 flex-wrap">
        <label class="cursor-pointer px-5 py-3 bg-neutral-800 hover:bg-neutral-700 rounded-xl text-white transition-all duration-300 flex items-center gap-2 border border-neutral-700">
        ...
        <div v-if="imagePreview" class="flex items-center gap-2 bg-neutral-800/50 border border-neutral-700 rounded-xl px-3 py-2 animate-fade-in">
